...
export const getRegistration = [
    ...
    ["country","createdAt","email","facebookUrl","firstName","game","gameCode","gameName","gamePublicPageShortUrl","gamePublicPageUrl","id","lastName","locale","nin","partner","partnerCode","partnerName","phone","progressRatio","publicToken","requestedGameDescription","requestedGameName","requestedOrganizationDescription","requestedOrganizationDomain","requestedOrganizationName","requestedOrganizationOverline","requestedOrganizationPresentation","requestedThemeCode","status","updatedAt","websiteUrl"],
];
export const me = [
    `query { me { @selections@ } }`,
