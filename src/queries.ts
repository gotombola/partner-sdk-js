...
export const getRegistration = [
    ...
    ["createdAt","email","facebookUrl","firstName","game","gameCode","gameName","gamePublicPageShortUrl","gamePublicPageUrl","id","lastName","partner","partnerCode","partnerName","phone","progressRatio","publicToken","status","updatedAt","websiteUrl"],
];
export const me = [
    `query { me { @selections@ } }`,
